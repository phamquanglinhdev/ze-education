...
class MusicCrudController extends CrudController
{
    ...
    {
        CRUD::column('name')->type('text')->label("Tên bài nhạc");
        CRUD::column('url')->type('link')->label("Đường dẫn");
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->type('text')->label("Tên bài nhạc");
        CRUD::field('url')->type('text')->label("Đường dẫn");
